...
const QVector<Cmd_struct> VC_fixed_commands = {
    ...
    //{PAGE_VC_FULL_LOOPER, 10, PATCH, CURRENT, BANKSELECT, 2, 3}, // ** Switch 10 **
    //{PAGE_VC_FULL_LOOPER, 11, PATCH, CURRENT, BANKSELECT, 3, 3}, // ** Switch 11 **
    ...
    {PAGE_VC_KPA_LOOPER, 13, PATCH, CURRENT, PREV, 3}, // ** Switch 13 **
    {PAGE_VC_KPA_LOOPER, 14, PATCH, CURRENT, NEXT, 3}, // ** Switch 14 **
...
const QVector<Cmd_struct> VCtouch_fixed_commands = {
      ...
      //{PAGE_VCTOUCH_CURRENT_PATCH_BANK, 14, SELECT_NEXT_DEVICE, COMMON}, // ** Switch 15 **
      //{PAGE_VCTOUCH_CURRENT_PATCH_BANK, 15, OPEN_NEXT_PAGE_OF_DEVICE, CURRENT}, // ** Switch 16 **
      ...
      //{PAGE_VCTOUCH_GR55_PATCH_BANK, 14, SELECT_NEXT_DEVICE, COMMON}, // ** Switch 14 **
      //{PAGE_VCTOUCH_GR55_PATCH_BANK, 15, OPEN_NEXT_PAGE_OF_DEVICE, CURRENT}, // ** Switch 15 **
      ...
      //{PAGE_VCTOUCH_ZOOM_PATCH_BANK, 15, NOTHING, COMMON}, // ** Switch 15 **
      ...
      //{PAGE_VCTOUCH_CURRENT_PARAMETER, 15, SELECT_NEXT_DEVICE, COMMON}, // ** Switch 15 **
      //{PAGE_VCTOUCH_CURRENT_PARAMETER, 15, OPEN_NEXT_PAGE_OF_DEVICE, CURRENT}, // ** Switch 15 **
      ...
      //{PAGE_VCTOUCH_GP10_ASSIGNS, 15, SELECT_NEXT_DEVICE, COMMON}, // ** Switch 15 **
      //{PAGE_VCTOUCH_GP10_ASSIGNS, 15, OPEN_NEXT_PAGE_OF_DEVICE, CURRENT}, // ** Switch 16 **
      ...
      //{PAGE_VCTOUCH_GR55_ASSIGNS, 15, SELECT_NEXT_DEVICE, COMMON}, // ** Switch 15 **
      //{PAGE_VCTOUCH_GR55_ASSIGNS, 15, OPEN_NEXT_PAGE_OF_DEVICE, CURRENT}, // ** Switch 16 **
      ...
      //{PAGE_VCTOUCH_VG99_EDIT, 15, SELECT_NEXT_DEVICE, COMMON}, // ** Switch 12 **
      //{PAGE_VCTOUCH_VG99_EDIT, 15, OPEN_NEXT_PAGE_OF_DEVICE, CURRENT}, // ** Switch 12 **

      // ******************************* PAGE 212: Line 6 M13 effects *************************************************
      ...
      {PAGE_VCTOUCH_FULL_LOOPER, 11, PATCH, CURRENT, 3, PREV}, // ** Switch 13 **
      {PAGE_VCTOUCH_FULL_LOOPER, 12, PATCH, CURRENT, 3, NEXT}, // ** Switch 14 **
      //{PAGE_VCTOUCH_FULL_LOOPER, 15, OPEN_NEXT_PAGE_OF_DEVICE, CURRENT}, // ** Switch 16 **

      // ******************************* PAGE 214: Helix_patch_bank (8 buttons per page) *************************************************
      ...
      // ******************************* PAGE 216: Snapshots (Helix) /scenes (AxeFX) *************************************************
      ...
      // ******************************* PAGE 217: KATANA_patch_bank (8 buttons per page) *************************************************
      ...
      {PAGE_VCTOUCH_KPA_LOOPER, 11, PATCH, CURRENT, PREV, 3}, // ** Switch 13 **
      {PAGE_VCTOUCH_KPA_LOOPER, 12, PATCH, CURRENT, NEXT, 3}, // ** Switch 14 **
      ...
      // ******************************* PAGE 222: Parameters current device *************************************************
      ...
      // ******************************* PAGE 223: SY1000_patch_bank (8 buttons per page) *************************************************
      ...
      // ******************************* PAGE 226: MG300_patch_bank (8 buttons per page) *************************************************
...
const uint16_t number_of_fixed_VCtouch_commands = VCtouch_fixed_commands.size();
...
const QVector<Cmd_struct> VCtouch_commands = {
        ...
        {PAGE_VCTOUCH_DEFAULT, 11, NOTHING, COMMON}, // ** Switch 11 **
        {PAGE_VCTOUCH_DEFAULT, 12, NOTHING, COMMON}, // ** Switch 12 **
