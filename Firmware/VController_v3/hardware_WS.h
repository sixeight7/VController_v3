...
#ifndef HARDWARE_WS_H
#define HARDWARE_WS_H

// This file contains all the hardware settings for the VController Custom Model.
// Make sure you include this file when updating to new firmware

#define VC_NAME "V-Controller"
#define HARDWARE_VERSION 6
...
// *** Switches (internal)
#define NUMBER_OF_SWITCHES 6  // Number of foot switches
#define NUMBER_OF_ENCODERS 0
#define NUMBER_OF_EXTERNAL_SWITCHES 4 // Count 2 switches per jack
#define NUMBER_OF_MIDI_SWITCHES 14 // Switches that only can be controlled thrugh MIDI
...
#define ROWPINS 14, 15, 16
#define COLUMNPINS 9, 6, 5, 4
...
#define NUMBER_OF_CTL_JACKS 2 // Number of jacks on the VController for connecting an expression pedal or two switches 
...
#define JACK1_PINS 20, 21, A6, A7, 1000
#define JACK2_PINS 22, 23, A8, A9, 1000
...
#define MAIN_LCD_DISPLAY_SIZE 20
...
#define DISPLAY_01_ADDRESS 0x23
#define DISPLAY_02_ADDRESS 0x24
#define DISPLAY_03_ADDRESS 0x25
#define DISPLAY_04_ADDRESS 0x26
