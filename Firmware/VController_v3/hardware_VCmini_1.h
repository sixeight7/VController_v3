...
#ifndef HARDWARE_VCM_1_H
#define HARDWARE_VCM_1_H
...
#define NEOPIXELLEDPIN     20  // The NeoPixel LEDs are connected to pin 17.
...
#define JACK1_PINS 34, 33, A15, A14, 900 // Changed
...
#define MENU_KEY_COMBINATION B00000101 // Both encoder switches pressed
#define YES_SWITCH 3
#define NO_SWITCH 1
...
#define MAIN_DISPLAY_TEENSY_PINS 2, 3, 4, 23, 6, 7, 8 // Pin 5 is fried, so we take no 23
