...
#ifndef HARDWARE_VCM_41_H
#define HARDWARE_VCM_41_H

// This file contains all the hardware settings for the VC-mini using the Teensy 4.1
...
#define MAIN_DISPLAY_TEENSY_PINS 3, 4, 5, 6, 9, 10 
