...
FLASHMEM void MD_ZMS_class::init() // Default values for variables
{
  ...
  my_device_page1 = ZMS_DEFAULT_VCTOUCH_PAGE1; // Default values for VC-touch
  my_device_page2 = ZMS_DEFAULT_VCTOUCH_PAGE2;
  my_device_page3 = ZMS_DEFAULT_VCTOUCH_PAGE3;
  my_device_page4 = ZMS_DEFAULT_VCTOUCH_PAGE4;
#elif defined(CONFIG_VCMINI)
  my_device_page1 = ZMS_DEFAULT_VCMINI_PAGE1; // Default values for VC-mini
  my_device_page2 = ZMS_DEFAULT_VCMINI_PAGE2;
  my_device_page3 = ZMS_DEFAULT_VCMINI_PAGE3;
  my_device_page4 = ZMS_DEFAULT_VCMINI_PAGE4;
#elif defined (CONFIG_CUSTOM)
  my_device_page1 = ZMS_DEFAULT_CUSTOM_PAGE1; // Default values for custom VC device
  my_device_page2 = ZMS_DEFAULT_CUSTOM_PAGE2;
  my_device_page3 = ZMS_DEFAULT_CUSTOM_PAGE3;
  my_device_page4 = ZMS_DEFAULT_CUSTOM_PAGE4;
#else
  my_device_page1 = ZMS_DEFAULT_VC_PAGE1; // Default values for VController
  my_device_page2 = ZMS_DEFAULT_VC_PAGE2;
  my_device_page3 = ZMS_DEFAULT_VC_PAGE3;
  my_device_page4 = ZMS_DEFAULT_VC_PAGE4;
#endif
